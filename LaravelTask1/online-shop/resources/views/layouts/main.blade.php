            ...
            <div class="col-lg-6 text-center text-lg-right">
                ...
                <div class="d-inline-flex align-items-center d-block d-lg-none">
                    <a href="" class="btn px-0 ml-2">
                        ...
                        <span class="badge text-dark border border-dark rounded-circle favourit_count"
                            style="padding-bottom: 2px">{{ count(session()->get('favourites', [])) }}</span>
                    </a>
                    <a href="" class="btn px-0 ml-2">
                        <i class="fas fa-shopping-cart text-dark"></i>
                        <span class="badge text-dark border border-dark rounded-circle product_count"
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        ...
                        <div class="navbar-nav ml-auto py-0 d-none d-lg-block">
                            <a href="" class="btn px-0">
                                ...
                                <span
                                    class="badge text-secondary border border-secondary rounded-circle favourit_count"
                                    style="padding-bottom: 2px">{{ count(session()->get('favourites', [])) }}</span>
                            </a>
                            <a href="" class="btn px-0 ml-3">
                                <i class="fas fa-shopping-cart text-primary"></i>
                                <span class="badge text-secondary border border-secondary rounded-circle product_count"
                                    style="padding-bottom: 2px">{{ count(session()->get('ids', [])) }}</span>
                            </a>
                        </div>
                    </div>
